...
//size控件大小 corners方向 radio圆角
+ (CALayer *)getMaskLayer:(CGRect)size byRoundingCorners:(UIRectCorner)corners cornerRadii:(NSInteger)radio{
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:size byRoundingCorners:UIRectCornerTopRight | UIRectCornerBottomRight cornerRadii:CGSizeMake(radio,radio)];
